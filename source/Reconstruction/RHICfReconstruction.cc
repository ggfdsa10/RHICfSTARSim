...
// 	      peaks.push_back(std::make_pair(htmp->GetMaximumBin()-1, htmp->GetMaximum()));
// 	    }
// 	  }
// 	}

//   // ================= sorting =================
//   const int peaksSize = peaks.size();
//   int sortedIdxArr[peaksSize][2]; // first, second
//   memset(sortedIdxArr, 0, sizeof(sortedIdxArr));
//   std::vector< value_type > peaks2;

//   for(int i=0; i<peaksSize; i++){
//     double tmpMax = 0;
//     double tmpIdx = 0;
//     for(int j=0; j<peaksSize; j++){
//       double height = peaks[j].second;

//       if(tmpMax < height && i == 0){
//         tmpMax = height;
//         tmpIdx = j;
//       }
//       if(tmpMax < height && height < sortedIdxArr[i-1][1] && i != 0){
//         tmpMax = height;
//         tmpIdx = j;
//       }
//     }

//     sortedIdxArr[i][0] = tmpIdx;
//     sortedIdxArr[i][1] = tmpMax;
//     peaks2.push_back(std::make_pair(peaks[tmpIdx].first, peaks[tmpIdx].second));
//   }
//   // ======================================
